...
def load_data_into_db():
    ...
    data = pd.read_csv('./leadscoring_test.csv')
    conn = None
...
def interactions_mapping_util(df, df_event_mapping):
    ...
    df_pivot = df.pivot_table(values='interaction_value', index=INDEX_COLUMNS_TRAINING, columns='interaction_mapping', aggfunc='sum')
